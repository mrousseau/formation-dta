...
//	private PizzaService pizzaService;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// Logger logger =
		// Logger.getLogger(ListerPizzaController.class.getName());
		// logger.log(Level.WARNING, "taille du tableau : " + o.size(), "");
		//

		// NE pas supprimer SANS CDI
		// RequestDispatcher dispatcher =
		// this.getServletContext().getRequestDispatcher("/WEB-INF/view/pizzas/listerPizzas.jsp");
		...
		// }else{
		// o = pizzaDao.findAll().stream().filter(p ->
		// p.isArchive()==false).collect(Collectors.toList());
