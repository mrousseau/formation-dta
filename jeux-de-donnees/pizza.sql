...
INSERT INTO `pizza` (`id`, `categoriePizza`, `code`, `nom`, `prix`) VALUES
(1, 'VIANDE', 'ORI', 'Oriental', 15.5),
(2, 'VIANDE', 'PEP', 'Pepperoni', 18.5),
(3, 'SANS_VIANDE', 'MAR', 'Margherita', 12.5),
(4, 'POISSON', 'SAU', 'Saumoneta', 15.5);
